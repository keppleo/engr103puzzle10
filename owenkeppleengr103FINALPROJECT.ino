...
void loop() {
  ...
  if (waitingForInput) {
    ...
    if((winningButton == 1 && CircuitPlayground.leftButton()) ||
        (winningButton == 0 && CircuitPlayground.rightButton()) || 
        (winningButton == 2 && CircuitPlayground.rightButton()) ||
        (winningButton == 2 && CircuitPlayground.leftButton())) { //punishment for pressing wrong button
          CircuitPlayground.clearPixels();
